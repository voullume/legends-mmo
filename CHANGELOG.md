...
_(rolls up commits since the previous tag; base f230580)_
...
_(rolls up commits since the previous tag; base f6eacda)_
...
_(rolls up commits since the previous tag; base a3d4235)_
...
_(rolls up commits since the previous tag; base 321ed6c)_

## v1.11.5 — 2026-07-21

- Wildlife Expanse ground re-skin (art pass A1): away zones = trampled range, Howler's den earth, basecamp cleared ground — client-only

_(rolls up commits since the previous tag; base 27a6b10)_

## v1.11.4 — 2026-07-21

- Lore polish: the stadium's treasures are a past challenger's — the wilds keep what they take

_(rolls up commits since the previous tag; base 8559090)_
